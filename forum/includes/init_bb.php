...
require(INC_DIR .'datastore/ds_common.php');
switch ($bb_cfg['datastore_type'])
{
	case 'sqlite':
		require(INC_DIR .'datastore/ds_sqlite.php');
		$datastore = new datastore_sqlite($bb_cfg['datastore']['sqlite']);
		break;
		
	case 'eaccelerator':
		require(INC_DIR .'datastore/ds_eaccelerator.php');
		$datastore = new datastore_eaccelerator();
		break;
		
	case 'memcached':
		require(INC_DIR .'datastore/ds_memcached.php');
		$datastore = new datastore_memcached($bb_cfg['datastore']['memcached']);
		break;
		
	case 'xcache':
		require(INC_DIR .'datastore/ds_xcache.php');
		$datastore = new datastore_xcache();
		break;
		
	case 'APC':
		require(INC_DIR .'datastore/ds_apc.php');
		$datastore = new datastore_apc();
		break;
		
	case 'filecache':
		require(INC_DIR .'datastore/ds_file.php');
		$datastore = new datastore_file(CACHE_DIR . $bb_cfg['datastore']['filecache']['path']);
		break;
		
	default:
		require(INC_DIR .'datastore/ds_mysql.php');
