...
if( isset($_POST['avatargallery']) && !$error )
{
	...
	display_avatar_gallery($mode, $avatar_category, $user_id, $email, $current_email, $username, $new_password, $cur_password, $password_confirm, $icq, $website, $location, $user_flag, $occupation, $interests, $signature, $viewemail, $notifypm, $notifyreply, $attachsig, $allowviewonline, 1, $user_lang, $user_timezone, $user_dateformat, $userdata['session_id']);
}
else
{
...
// FLAGHACK-end
	...
	$template->assign_vars(array(
		...
		'L_CONFIRM_PASSWORD_EXP' => ( $mode == 'editprofile' ) ? $lang['CONFIRM_PASSWORD_EXPLAIN'] : '',
		'L_PASSWORD_IF_CHAN' => ( $mode == 'editprofile' ) ? $lang['PASSWORD_IF_CHANGED'] : '',
		'L_PASSWORD_CONFIRM_IF_CHAN' => ( $mode == 'editprofile' ) ? $lang['PASSWORD_CONFIRM_IF_CHANGED'] : '',
		...
		'L_CONFIRM_CODE_IMP'	=> sprintf($lang['CONFIRM_CODE_IMPAIRED'], '<a href="mailto:' . $bb_cfg['board_email'] . '">', '</a>'),
