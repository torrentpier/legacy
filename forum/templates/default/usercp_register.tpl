...
<tr>
	<td>{L_CURRENT_PASSWORD}: * <h6>{L_CONFIRM_PASSWORD_EXP}</h6></td>
	<td><input type="password" name="cur_password" size="35" maxlength="20" /></td>
</tr>
<!-- END switch_edit_profile -->
<tr>
	<td>{T_NEW_PASSWORD}: * <h6>{L_PASSWORD_IF_CHAN}</h6></td>
	<td><input type="password" name="new_password" size="35" maxlength="20" /></td>
</tr>
<tr>
	<td>{L_CONFIRM_PASSWORD}: * <h6>{L_PASSWORD_CONFIRM_IF_CHAN}</h6></td>
...
<tr>
	<td colspan="2" class="med tCenter">{L_CONFIRM_CODE_IMP}<p class="mrg_10">{CONFIRM_IMG}</p></td>
</tr>
<tr>
